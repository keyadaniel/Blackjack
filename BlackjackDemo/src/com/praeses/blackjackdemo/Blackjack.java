...
//while loop for bank
		...
		while (playerMoney > 0) {
			...
			try {
				playerBet = Double.parseDouble(userInput.nextLine());
			...
			while (true) {
				...
				if (response == 1) {
					 ...
					 * if(playerHand.cardsValue() == 21 && dealerHand.cardsValue() != 21) {
					 * System.out.println(playerHand.toString());
					 * System.out.println(playerHand.cardsValue()); System.out.println("BLACKJACK");
					 * playerMoney += (playerBet * 2); endRound = false; }
					 */
				}
